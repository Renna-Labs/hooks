...
function App() {
  ...
  return <h1 data-testid="test-header">{`pageXOffset is ${x}, pageYOffset is ${y}`}</h1>;
}
...
describe('useWindowScrollPosition()', () => {
  test('returns correct values', () => {
    ...
    expect(getByTestId('test-header')).toHaveTextContent('pageXOffset is 50, pageYOffset is 100');
  });
});
